...
if (isset($_POST['common_video'])) {
 ...
 for ($i=0; $i<count($imgarray); $i++) {
   ...
   include '../../methods/send-notification.php';
     ...
     insert_notification($conn,$user_id,"vendor","true","false","Created","New listing has been posted for review.","".$name." in ".$hotelName." has been posted for review by ".$_SESSION['reg_name'],date("F j, Y, g:i a"),"rooms/showsingle_roomrecord.php?id=".$room_id."&h_id=".$hotelid."&status=Pending&name=".$_SESSION['reg_name']."&user_id=".$user_id,"room","admin" );
