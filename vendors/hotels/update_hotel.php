...
$hotlupdate='SELECT `hotel`.`hotel_inactive` FROM `hotel` WHERE hotel_id="'.$h_id.'"';
  ...
  $notify_descrip="".$name." hotel has been updated by ".$_SESSION['reg_name']."";
     ...
     insert_notification($conn,$user_id,"vendor","true","false","Updated",$notify_title,$notify_descrip,date("F j, Y, g:i a"),"hotels/showsingle_hotelrecord.php?id=".$h_id."&status=Approved&name=".$_SESSION['reg_name'],"hotel","admin","listing_on","true" );
