...
if ($is_check==true) {
 ...
 if (isset($_SESSION['user_type']) && $_SESSION['user_type']=="admin") {
	...
	insert_notification($conn,$_POST['user_id'] ,"admin","true","false",$notify_istime,$notify_title,$notify_descrip,date("F j, Y, g:i a"),"faqs/editQues.php?f_id=".$faq_id."&id=".$_POST['user_id'],"faq","s_admin","","true");
}
