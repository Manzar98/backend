		...
		<div class="db-cent-table db-com-table">
			<div class="row">
				<div class="db-title col s9">
					<h3><img src="../../images/icon/dbc5.png" alt=""/> List Of Amenities</h3>
			...
			<table class="bordered responsive-table" id="h_table">
				...
				<tbody class="wrap-td">
					...
					<tr class="tr-1 veiw_sus_appr">
						<td class="td-name capitalize"><?php echo $result['amenity_name'] ?></td>
						<td class="td-name capitalize"><?php echo $result['amenity_description'] ?></td>
			...
			<div class="text-center"><span>Sorry! no amenities</span></div>
			<div class="row common-top text-center">
				<div class="">
					<a class="waves-effect waves-light btn modal-trigger spc-modal" href="addAmenity.php?id=<?php echo $_GET['id']; ?>">Add New Amenity</a>
				</div>
			</div>
			<?php	}?>
		</div>
