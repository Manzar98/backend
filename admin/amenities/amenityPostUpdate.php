...
if ($is_check==true) {
	...
	if (isset($_SESSION['user_type']) && $_SESSION['user_type']=="admin") {
		...
		insert_notification($conn,$_POST['user_id'] ,"admin","true","false",$notify_istime,$notify_title,$notify_descrip,date("F j, Y, g:i a"),"amenities/amenityListing.php?a_id=".$_POST['crnt_a_id']."&id=".$_POST['user_id']."&a_name=".$_POST['amenity_name'],"amenities","s_admin","","true" );
	}
