...
<head>
	<?php if(isset($_GET['fee_id']) && $_GET['fee_id']){ ?>
		<title>Edit Service Fee For Vendor's</title>
	<?php }else{ ?>
		<title>Add Service Fee For Vendor's</title>
	<?php } ?>
	...
	<div class="db-cent-3">
		<div class="db-cent-table db-com-table">
			<div class="db-title">
				<?php if (isset($_GET['fee_id']) && $_GET['fee_id']) { ?>
					<h3><img src="../../images/icon/dbc5.png" alt=""/> Add Service Fee For Vendor's</h3>
				<?php }else{ ?>
					<h3><img src="../../images/icon/dbc5.png" alt=""/> Edit Service Fee For Vendor's</h3>
				<?php } ?>
			...
			<?php if (isset($_GET['fee_id']) && $_GET['fee_id']) { 
				...
				<form class="col s12"  data-toggle="validator" id="serviceFee-form" role="form" action="" method="POST" enctype="multipart/form-data">
					...
					<input type="hidden" name="fee_user_type" value="vendor">
