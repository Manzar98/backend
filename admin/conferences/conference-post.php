...
if (isset($_POST['common_video'])) {
 ...
 for ($i=0; $i<count($imgarray); $i++) {
  ...
  include '../../methods/send-notification.php';
     ...
     insert_notification($conn,$userid ,"admin","true","false","Created","New conference created under your account.","".$name." in ".$con_hotelName." has been created under your account",date("F j, Y, g:i a"),"conferences/showsingle_conferencerecord.php?id=".$conference_id."&h_id=".$hotelid,"conference","vendor" );
...
if (isset($_POST['common_video'])) {
 ...
 for ($i=0; $i<count($imgarray); $i++) {
  ...
  include '../../methods/send-notification.php';
     ...
     insert_notification($conn,$userid ,"admin","true","false","Created","New conference created under your account.","".$name." has been created under your account",date("F j, Y, g:i a"),"conferences/showsingle_conferencerecord.php?id=".$conference_id."&u_id=".$userid ,"conference","vendor" );
