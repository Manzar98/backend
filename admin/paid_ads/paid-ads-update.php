...
if (!isset($_POST['btn'])) {
 ...
 if (isset($_POST['reason'])) {
   ...
   if ($_SESSION['user_type']=="admin") {
    ...
    insert_notification($conn,$_POST['u_id'],"admin","true","false","Suspended","Ad Suspended","".$_SESSION['reg_name']." has been suspended featured ".$lst_any." ad",date("F j, Y, g:i a"),"#","paid-ads","s_admin","" );
  }
 ...
 if ($_SESSION['user_type']=="admin") {
  ...
  insert_notification($conn,$_POST['u_id'],"admin","true","false","Approved","Ad Approved","".$_SESSION['reg_name']." has been approved featured ".$lst_any." ad",date("F j, Y, g:i a"),"#","paid-ads","s_admin","" );
}
