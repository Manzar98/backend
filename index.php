                	...
                	<form class="col s8" role="form" action="auth.php" method="POST" enctype="multipart/form-data" id="login-form">
						<div>
							<div class="input-field">
								<input type="email" name="email" onkeyup="enterBTN(event)"   class="validate">
								<label>Email</label>
							</div>
						</div>
						<div>
							<div class="input-field">
								<input type="password" name="password" onkeyup="enterBTN(event)" class="validate">
						...
						<div class="row">
							...
							<div class="col-md-3  pull-right">
								<p class="registor">
									 <a href="vendors/registration/registration.php">Registration?</a>
								</p>
							</div>
						</div>
						<div>
