                         ...
                         this.on("success", function(file,response)
                         {
                          ...
                          if ($('#photo_type').val() == 'interior' ) {
                                       ...
                                       if (parent.document.getElementById('img_ids').value == "") {
                                        ...
                                        var singleImg = $('<div class="imgeWrap" ><a class="deletIMG" onclick="deletIMG(event)" data-value="'+updatedResponse.id+'" data-img="'+updatedResponse.filename+'"><i class="fa fa-times" aria-hidden="true"></i></a><img src="../'+updatedResponse.filename+'" width="150" class="materialboxed"></div>');
